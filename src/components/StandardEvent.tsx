...
const StandardEvent = () => {
    const [standard, setStandard] = useState<string>('daily');
            ...
            <form className='shadow-md px-2 py-3 rounded-lg'>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <label>Repeat : </label>
                            <select onChange={(e)=>setStandard(e.target.value)} className='border-solid border-sky-100 border-2 w-full mb-2 focus:outline-yellow-200 p-1'>
